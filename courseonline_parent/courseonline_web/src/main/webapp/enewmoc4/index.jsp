...
<script type="text/javascript" src="${pageContext.request.contextPath }/enewmoc4/rs-plugin/js/jquery.themepunch.revolution.min.js"></script>
<link rel="stylesheet" href="${pageContext.request.contextPath }/enewmoc4/css/style.css"/>
<link rel="stylesheet" href="${pageContext.request.contextPath }/enewmoc4/css/tab.css" media="screen">
<link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath }/enewmoc4/css/main.css" id="main-css">
<!--课程选项卡-->
...
<div class="head" id="fixed">
	<div class="nav">
        ...
        <!--<span class="select">
            ...
            <!--  
            <a href="#"  onMouseOver="logmine()" style="width:70px" class="link2 he ico" target="_blank">sherley</a>
            <span id="lne" style="display:none" onMouseOut="logclose()" onMouseOver="logmine()">
                <span style="background:#fff;">
                	<a href="${pageContext.request.contextPath }/enewmoc4/mycourse.jsp" style="width:70px; display:block;" class="link2 he ico" target="_blank">sherley</a>
                </span>
			...
			<ul>
            	 <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="images-slider/thumbs/thumb1.jpg">
					...
					<div class="tp-caption sfl"
						...
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/rb.png" alt="">
					</div>
				 ...
				 <li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="${pageContext.request.contextPath }/enewmoc4/images-slider/thumbs/thumb1.jpg">
					<!--  BACKGROUND IMAGE -->
					<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/wide3.jpg" alt="" />
					...
					<div class="tp-caption small-white lft"
						...
						data-start="2600"
						data-easing="easeOutExpo">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/spotlight.png" alt="">
					</div>
					...
					<div class="tp-caption fade"
						...
						data-start="2600"
						data-easing="easeOutExpo">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/guy.png" alt="">
					</div>
				</li>
				...
				<li data-transition="fade" data-slotamount="10" data-masterspeed="300" data-thumb="${pageContext.request.contextPath }/enewmoc4/images-slider/thumbs/thumb1.jpg">
					<!--  BACKGROUND IMAGE -->
					<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/wide1.jpg" alt="" />
					...
					<div class="caption large_text sfb"
						...
						data-start="800"
						data-easing="easeOutExpo">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/our-features.png" alt="">
					</div>
					...
					<div class="tp-caption sfr"
						...
						data-start="1000"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/lu.png" alt="">
					</div>
					...
					<div class="tp-caption sfr"
						...
						data-start="1200"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/clean.png" alt="">
					</div>
					...
					<div class="tp-caption sfr"
						...
						data-start="1400"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/lm.png" alt="">
					</div>
					...
					<div class="tp-caption sfr"
						...
						data-start="1600"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/responsive.png" alt="">
					</div>
					...
					<div class="tp-caption sfr"
						...
						data-start="1800"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/lb.png" alt="">
					</div>
					...
					<div class="tp-caption sfr"
						...
						data-start="2000"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/bootstrap.png" alt="">
					</div>
					...
					<div class="tp-caption sfl"
						...
						data-start="2200"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/ru.png" alt="">
					</div>
					...
					<div class="tp-caption sfl"
						...
						data-start="2400"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/solid.png" alt="">
					</div>
					...
					<div class="tp-caption sfl"
						...
						data-start="2600"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/rm.png" alt="">
					</div>
					...
					<div class="tp-caption sfl"
						...
						data-start="2800"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/lightweight.png" alt="">
					</div>
					...
					<div class="tp-caption sfl"
						...
						data-start="3200"
						data-easing="easeOutBack">
						<img src="${pageContext.request.contextPath }/enewmoc4/images-slider/fresh.png" alt="">
					</div>
				</li>
...
<div class="td1">
	<div class="tdcont">
    	<span class="tdimg"><img src="${pageContext.request.contextPath }/enewmoc4/images/ico4.jpg" width="450"></span>
        <span class="tdtext">
        	<h3>完全免费课程</h3>
            <p>精心录制视频课程与讲解，全部课程完全免费。</p><br/>
            <p><a href="#" class="btninto">开始学习</a></p>
        </span><%-- ${pageContext.request.contextPath }/enewmoc4/courselist.jsp --%>
        <div style="clear:both"></div>
    </div>
</div>
<div class="td2">
	<div class="tdcont">
    	<span class="tdimg1"><img src="${pageContext.request.contextPath }/enewmoc4/images/ico5.jpg" width="500"></span>
        <span class="tdtext1">
        	<h3 class="co1">智能评估题库</h3>
            <p>智能能力评估，学员可以通过具体题目，匹配相
关知识点,文字解析与视频解析相结合。</p><br/>
			<p><a href="" class="btninto">点击测评</a></p>
        </span><%-- ${pageContext.request.contextPath }/enewmoc4/training.jsp --%>
        <div style="clear:both"></div>
    </div>
</div>
<div class="td1">
	<div class="tdcont np">
    	<span class="tdimg" style="margin-top:80px"><img src="${pageContext.request.contextPath }/enewmoc4/images/ico6.jpg" width="550"></span>
        <span class="tdtext" style="margin-top:120px">
        	<h3 class="co2">智能匹配练习</h3>
            <p class="tex1">跟随视频课程同步练习，紧扣重点难
点，点点精通。</p><br/>
			<p><a href="" class="btninto">开始练习</a></p>
        </span><%-- ${pageContext.request.contextPath }/enewmoc4/training.jsp --%>
        <div style="clear:both"></div>
    </div>
</div>
<div class="td2 np">
	<div class="tdcont np">
    	<span class="tdimg1 ni"><img src="${pageContext.request.contextPath }/enewmoc4/images/ico7.png" width="300"></span>
...
<!--<span class="morecourse"><a href="${pageContext.request.contextPath }/enewmoc4/courselist.jsp" class="btnlink">更多课程</a></span>
-->
</div>
<div class="foot">
