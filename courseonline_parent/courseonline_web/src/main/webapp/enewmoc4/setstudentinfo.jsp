            ...
            <div class="logined">
                ...
                <span id="lne" style="display:none" onMouseOut="logclose()" onMouseOver="logmine()">
                    ...
                    <ul class="logmine" >
                        ...
                        <li><a class="link1" href="${pageContext.request.contextPath }/studentAction_myinfo?studentId=<s:property value="#session.studentInfo.studentId"/>">我的信息</a></li>
...
<div class="memblist">
    ...
    <ul>
		...
		<li class="currnav"><a class="mb4" href="${pageContext.request.contextPath }/enewmoc4/studentinfo.jsp">我的信息</a></li>
...
<div class="box demo2" style="width:820px;">
		...
		<form class="af-form" id="af-form" action="studentAction_fronteditInfo"  method="post" novalidate>
			
			<input type="hidden" name="studentId" value="<s:property value="#session.studentInfo.studentId" />">
			<div class="af-outer af-required">
				<div class="af-inner">
					<label for="input-name">姓名</label>
					<input type="text" name="name" id="input-name"  value="<s:property value="#session.studentInfo.name"/>" readonly="readonly"  required>
				</div>
			</div>
			<div class="af-outer af-required">
				<div class="af-inner">
			...
			<div class="af-outer af-required">
				<div class="af-inner">
					...
					<input type="text" name="sex" id="input-sex" value="<s:property value="#session.studentInfo.sex"/>" readonly="readonly"  required>
				</div>
			</div>
			...
			<div class="af-outer">
				<div class="af-inner">
				  ...
				  <input type="email" name="tel" id="input-phone" value="<s:property value="#session.studentInfo.tel"/>" readonly="readonly" >
				</div>
			</div>
