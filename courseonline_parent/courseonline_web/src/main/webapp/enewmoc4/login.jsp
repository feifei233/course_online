...
<div class="login" style="background:url(/enewmoc4/images/12.jpg) right center no-repeat #fff">
<h2>登录</h2>
<form method="post" action="loginAction_frontlogin.action"  style="width:600px">
<div>
    <p class="formrow">
    <label class="control-label" for="register_email">帐号</label>
    <input type="text" name="id">
    </p>
    <!--<span class="text-danger">请输入用户账号</span>-->
</div>
<div>
    <p class="formrow">
    ...
    <input type="password"  name="password">
     ...
     <p class="help-block"><span class="text-danger"><font color="red"><s:actionerror/></font></span></p>
</div>
...
<div class="loginbtn lb">
   ...
   <span>&nbsp;&nbsp;|&nbsp;&nbsp;</span>   
   <a href="forgetpassword.jsp" class="link-muted">找回密码</a>
</div>
</form>
<div class="hezuologo">
    <span class="hezuo">使用合作网站账号登录</span>
    <div class="hezuoimg">
    <img src="${pageContext.request.contextPath }/enewmoc4/images/hezuoqq.png" class="hzqq" title="QQ" width="40" height="40"/>
    <img src="${pageContext.request.contextPath }/enewmoc4/images/hezuowb.png" class="hzwb" title="微博" width="40" height="40"/>
    </div>
