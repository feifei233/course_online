	...
	$(function() {
		...
		$("#btnEp").click(function(){
			...
			if(v){
				...
				if(v1 == v2){
					//两次密码一致
					$.post("userAction_editPwd.action",{"password":v1},function(data){
						if(data == '1'){
							//修改成功，关闭修改密码窗口
							$("#editPwdWindow").window("close");
						}else{
						...
						<table cellpadding=3>
							<tr>
								...
								<td><input required="true"
									data-options="validType:'length[4,12]'" id="txtNewPass"
									type="Password" class="txt01 easyui-validatebox" /></td>
							</tr>
							<tr>
								<td>确认密码：</td>
								<td><input required="true"
									data-options="validType:'length[4,12]'" id="txtRePass"
									type="Password" class="txt01 easyui-validatebox" /></td>
							</tr>
						</table>
					</form>
